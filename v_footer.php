							...
							<div class="col-lg-3 footer_col">
								...
								<div class="footer_section footer_about">
									<div class="footer_logo_container">
										<a href="<?= base_url() ?>">
											<div class="footer_logo_text">Desa<span> Sukamaju</span></div>
										</a>
									</div>
							...
							<div class="col-lg-3 footer_col">
								...
								<div class="footer_section footer_contact">
									...
									<div class="footer_contact_info">
										<ul>
											<li>Jl. Raya Sukamaju Nomor 394, Kec. Mangunjaya 46571</li>
											<li>Kab.Pangandaran, Prov. Jawa Barat</li>
											<li>Email: desasukamaju2@gmail.com</li>
										</ul>
									</div>
								</div>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> DNFS</a>
