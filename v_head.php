...
<html lang="en">
<head>
<title>Desa Sukamaju : <?= $title ?></title>
<meta charset="utf-8">
...
<link href="<?= base_url() ?>template/front-end/plugins/colorbox/colorbox.css"> 
...
<link rel="stylesheet" type="text/css" href="<?= base_url() ?>template/front-end/databables/databables.min.css"/>
<link rel="stylesheet" type="text/css" href="<?= base_url() ?>template/front-end/styles/blog_single.css">

<link rel="stylesheet" type="text/css" href="<?= base_url() ?>template/front-end/styles/dataTables/dataTables.min.css">

<script type="text/javascript" src="<?= base_url() ?>template/styles/dataTables/dataTables.min.js"></script>

<link rel="stylesheet" type="text/css" href="<?= base_url() ?>template/styles/blog_single_responsive.css">
